...
Ablation Study  about   2)Effect of multi-attention mechanism       2-6  SA GA attention

Three branches,  just SA GA,  no full Conection layer   
...
class GlGraphConv(nn.Module):
    ...
    def forward(self, input):
        ...
        output = torch.matmul(adj * M, h0) + torch.matmul(self.adj* (1 - M), h1)   #just use SA, not use NA
