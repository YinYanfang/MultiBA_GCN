...
Ablation Study  about   2)Effect of multi-attention mechanism       2-3  NA attention

two branches, just NA , Neighbor Attention，  no full Conection layer 
#
'''
...
#       
    ...
    def forward(self, input):
        ...
        output = h0 + torch.matmul(adj * (1 - M), h1)   #only NA,
