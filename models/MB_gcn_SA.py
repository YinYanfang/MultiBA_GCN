...
Ablation Study  about   2)Effect of multi-attention mechanism       2-2  SA attention

two branches, just SA ,self Attention，  no full Conection layer 
#
'''
...
#      
    ...
    def forward(self, input):
        ...
        output = torch.matmul(adj * M, h0) + torch.matmul(self.adj* (1 - M), h1)   #just use SA 
