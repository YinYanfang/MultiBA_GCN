...
Ablation Study  about   2)Effect of multi-attention mechanism       2-4  GA attention

Three branches, just GA , Neighbor Attention，  no full Conection layer 
#
'''
...
class GlGraphConv(nn.Module):
    ...
    def forward(self, input):
        ...
        output = h0 + torch.matmul(self.adj* (1 - M), h1)   # multi branch
