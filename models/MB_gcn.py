...
Ablation Study  about   1)Effect of multi-branch feature extraction of GCN     1-2  multi-branches
                        2)Effect of multi-attention mechanism                  2-1  no any attention

two branches, no attention, no Full connect layer 
